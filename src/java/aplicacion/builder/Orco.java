...
public class Orco extends PersonajeBuilder{
    ...
    public void buildMontura() {
        ...
        montura.setTipo_montura("img/MonturaOrco.png");
    ...
    public void buildArma() {
        ...
        Arma arma = new Arma();
        arma.setTipo_arma("img/ArmaOrco.png");
    ...
    public void buildEscudo() {
        ...
        escudo.setTipo_escudo("img/EscudoOrco.png");
    ...
    public void buildCuerpo() {
        ...
        cuerpo.setTipo_cuerpo("img/CuerpoOrco.png");
